...
const enableValidation = (validateObject) => {
  const formList = Array.from(
    document.querySelectorAll(validateObject.formSelector)
  );
...
function createCard(userId, data) {
  const card = new Card(userId, data, ".card-template", {
    handleCardClick,
    handleDeleteClick: () => {
      ...
      popupCardDelete.addSubmitAction(popupCardDeleteAction);
